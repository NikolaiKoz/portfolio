        ...
        <div>
            ...
            <form>
                ...
                <div>
                    ...
                    <input type="text" name="affair" id="affair" placeholder="Ingrese el motivo de su mensaje" />
                </div>
                <div>
                    <label htmlFor="message">Mensaje</label>
                    <input type="text" name="message" id="message" placeholder="Ingrese su correo" />
                </div>
                <div>
